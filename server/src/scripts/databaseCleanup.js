...
const MAX_ALLOWED_DATE = '2023-11-05T00:00:00.000+00:00';
...
mongoose.connect("mongodb+srv://drace:devashish@news.mongodb.net/test.news?retryWrites=true&w=majority", mongooseOptions)
.then(async () => {
